...
local Library = {
    ...
    GlowColor = Color3.fromRGB(207, 35, 85);
...
function Library:CreateWindow(...)
    ...
    local GlowFrame = Library:Create('Frame', {
        BackgroundColor3 = Library.GlowColor,
        BorderSizePixel = 0,
        Position = UDim2.fromScale(0.5, 0.5),
        Size = UDim2.fromOffset(Outer.AbsoluteSize.X + 8, Outer.AbsoluteSize.Y + 8),
        AnchorPoint = Vector2.new(0.5, 0.5),
        Visible = false,
        ZIndex = 0,
        Parent = ScreenGui,
    ...
    Library:Create('UIGradient', {
        Color = ColorSequence.new(Library.GlowColor, Library.BackgroundColor),
